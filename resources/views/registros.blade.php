...
<div class="tile is-ancestor">
        <div class="tile is-parent is-vertical">
            ...
            <article onclick="location.href ='UsuarioGlicoseRegistros'" class="tile is-child notification is-info">
            ...
            <article onclick="location.href ='UsuarioPressaoArterialRegistros'" class="tile is-child notification is-info">
            ...
            <article onclick="location.href ='UsuarioBatimentosCardiacosRegistros'" class="tile is-child notification is-info">
            ...
            <article onclick="location.href ='UsuarioPesoRegistros'" class="tile is-child notification is-info">
